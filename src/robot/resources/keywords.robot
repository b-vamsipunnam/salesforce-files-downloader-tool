    ...
    WHILE    ${TRUE}
        ...
        IF    $resp is None
            IF    ${page_number} == 1
                ...
                RETURN                     ${all_records}
            END
            Fail                           Salesforce SOQL pagination failed while retrieving page ${page_number}. Partial results were discarded.
        END
           ...
           ELSE
                 ...
                 IF    '${download_status}' == 'PASS'
                        ...
                        IF    '${GENERATE_CONTENT_DOCUMENT_LINK_FILE.lower()}' == 'yes'
                               ...
                               ${cdl_row}=       Evaluate      ${cdl_row} + ${link_count}
                        END
                 END
           END
    END
...
Get ContentDocumentID Details and Launch the URL
    ...
    ${download_result}=                    Download And Validate Content File                                           ${content_id}                    ${download_url}                             ${content_links}                            ${cv_row}                                   ${cdl_row}
...
Download And Validate Content File
    ...
    END
    ${validation_status}=    Validate And Move Downloaded File              ${latest_filename}    ${content_id}         ${content_links}         ${FILE_STABILITY_TIMEOUT}         ${cv_row}        ${cdl_row}
    ...
    IF    '${target_file_exists}' == 'True' and '${is_file_size_matching}' == 'True'
           ...
           IF    '${GENERATE_CONTENT_DOCUMENT_LINK_FILE.lower()}' == 'yes'
                  ...
                  FOR    ${content_link}    IN    @{content_links}
                         Write ContentDocumentLink Row      ${current_cdl_row}     ${content_link}
                         ${current_cdl_row}=    Evaluate    ${current_cdl_row} + 1
                  END
           END
